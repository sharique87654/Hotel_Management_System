...
export default function Booking() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-950 to-black">
      ...
      <div className="text-center mt-[6rem] px-4 pb-24 pt-8">
        {/* Hero */}
        <div className="mb-7">
        ...
        {/* Search Section */}
        <div className="flex flex-col sm:flex-row justify-center items-center gap-3 mb-7 max-w-3xl mx-auto">
          <input
            type="text"
        ...
        {/* Thin gradient line */}
        <div className="w-full h-[2px] bg-gradient-to-r from-transparent via-blue-500/60 to-transparent mb-7"></div>
